...
class Ui_PrintQR(object):
    ...
    def setupUi(self, PrintQR):
        ...
        #self.module_names.activated[str].connect(self.moduleActivated)
        #self.boards_ver.activated[str].connect(self.boardActivated)
        #self.builds_ver.activated[str].connect(self.buildActivated)
